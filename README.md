...
- [Prbl](https://getprbl.com) - Security scanner for AI-generated code. Scans a repo or a live URL for hardcoded secrets, missing authorization, injection and exposed databases; free GitHub Action comments findings on every pull request.
